...
import { CANCEL_ORDER, CREATE_ORDER, GET_DEPTH, GET_OPEN_ORDER, MessageFromApi, ON_RAMP } from "../types/fromApi";
        ...
        switch (message.type) {
            ...
            case GET_DEPTH:
                try {
                    ...
                    console.log("orderbook depth: " + orderbook.getDepth());
